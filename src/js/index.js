...
const resetPage = () => {
    ...
    if (!mobileAndTabletCheck()) {
        let myModal = new Modal({
            title: 'Are you using a mobile device?',
            content: 'Due to the nature of a typing speed test, you will be unable to perform the test on your mobile device. Try this app on a device with a keyboard.'
        }).show();
    }
